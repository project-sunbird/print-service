...
const envVariables = {
  ...
  //  azureAccountKey: process.env.sunbird_azure_account_key,
    ...
    azureAccountKey: "vargAkoG7Vgqtiu1ONHSYnEzG3UJmt5iH2YKWNCCEN9qUfcOhG9Y39kneCvDzCoTew+BHEeqIDEFKdMT56dWcg==",
    azureContainerName: "e-credentials",
    azureAccountName: "sunbirddev",
    encodingType: "UTF-8"
}
